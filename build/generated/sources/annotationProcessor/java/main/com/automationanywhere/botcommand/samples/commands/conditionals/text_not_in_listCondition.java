...
public final class text_not_in_listCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(text_not_in_listCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    text_not_in_list command = new text_not_in_list();
